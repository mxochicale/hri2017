...
\keywords{Humanoid dance robot, movement variability}
...
Similarly, NAO acted as a tutor to guide 10 children to teach dance with the 
\textit{concept-based learning} in which the robot guides the child 
thorough different stages of dance across three sessions \cite{Ros2014}.
...
In the same vein of dancing with robots, \textit{Keepon}, a non-humanoid-robot, showed a positive effect on the children's rhythmic behavior.
...
to which we are proposing the use of NAO and inertial sensors attached to the persons
to analyse the movement variability in simple dance activities. 
With this,  we belive that the outcome can help us to quantify the level of dexterity of dancers
as well as provide feedback to dance better.
