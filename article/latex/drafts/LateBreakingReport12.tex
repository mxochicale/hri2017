...
in order to quantify how closely a healthy participant imitates a robot
...
% % % % % SECTION REWRITTEN BY C.BABER
% It was anticipated that the robot performed very similar repetitions of movements 
...
% that the proposed metric reveals 
