...
In this study, we propose a metric based on the state space reconstruction
in order to quantify how close a healthy participant imitates a robot
in which we use inertial sensors attached both to a person and to a humanoid-robot.
